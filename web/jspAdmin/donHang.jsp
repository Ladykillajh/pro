<%-- 
    Document   : donHang
    Created on : Oct 22, 2019, 8:50:17 AM
    Author     : DATPT
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" style="padding: 10% 10%; padding-bottom: 0%">
            <table class="table">
                <tr>
                    <th><a href="./insert/InsertDonHang.jsp"> <button class="btn btn-primary">Thêm Đơn Hàng</button></a></th>
                </tr>
            </table>
            <hr>
            ...
            <table border="1" cellspacing="10px" class="table">
                ...
                <c:forEach var="d" items="${donHang}">
                    <tr>
                        ...
                        <td>
                            <a href="updateDonHang?maDonHang=${d.maDonHang}"><input type="submit" class="btn btn-info" value="Sửa"/></a> 
                            <a href="DeleteDonHang?maDonHang=${t.maDonHang}"><input type="submit" class="btn btn-danger" value="Xóa"/></a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
