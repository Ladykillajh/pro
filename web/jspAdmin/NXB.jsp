<%-- 
    Document   : NXB
    Created on : Oct 22, 2019, 8:24:51 AM
    Author     : DATPT
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" style="padding: 10% 10%; padding-bottom: 0%">
            <table class="table">
                <tr>
                    <th><a href="InsertNXB.jsp"> <button class="btn btn-primary">Thêm Nhà Xuất Bản</button></a></th>
                </tr>
            </table>
            <hr>
            ...
            <table border="1" cellspacing="10px" class="table">
                ...
                <c:forEach var="n" items="${NXB}">
                    <tr>
                        ...
                        <td>
                            <a href="updateNXB?maNXB=${n.maNXB}"><input type="submit" class="btn btn-info" value="Sửa"/></a> 
                            <a href="DeleteNXB?maNXB=${t.maNxb}"><input type="submit" class="btn btn-danger" value="Xóa"/></a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
