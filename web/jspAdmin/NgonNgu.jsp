<%-- 
    Document   : NgonNgu
    Created on : Oct 23, 2019, 11:04:37 AM
    Author     : Auriat
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" style="padding: 10% 10%; padding-bottom: 0%">
            <table class="table">
                <tr>
                    <th><a href="InsertNgonNgu.jsp"> <button class="btn btn-primary">Thêm Ngôn Ngữ</button></a></th>
                </tr>
            </table>
            <hr>
        ...
        <div class="container-fluid" style="padding: 2% 10%;text-align: center;vertical-align: central;text-justify: auto">
            ...
            <table border="1" cellspacing="10px" class="table">
                ...
                <c:forEach var="nn" items="${NgonNgu}">
                    <tr>
                        <td>${nn.maNgonNgu}</td>
                        <td>${nn.tenNgonNgu}</td>

                        <td>
                            <a href="updateNgonNgu?maNgonNgu=${nn.maNgonNgu}"><input type="submit" class="btn btn-info" value="Sửa"/></a> 
