...
<html>
    ...
    <body>
        ...
        <div class="container" style="padding: 10% 10%">
            <div class="jumbotron">
                <h3 class="display-3">Mua Ngay</h3>
            </div>
            <form action="muasach">
                <table class="table">
                    <tr>
                    ...
                    <c:forEach var="mh" items="${muahang}">
                        <tr>
                            ...
                            <td>${mh.tenSach}</td>
                            <td>${mh.giaBia}</td>                
                            <td><a href="updatekhmua?user=${sessionScope.login.username}"><input class="btn btn-primary" type="button" value="Thanh Toán" name="mua"</a>
                                <input class="btn btn-danger" type="submit" value="Cancel" name="deomuanua">
                            </td>
                        </tr>
                    </c:forEach>
                </table>
