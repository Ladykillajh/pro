 ...
 * @author dell
 */
public class UpdateNXBController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("update", update.selectByMaNXB(maNXB));
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/update/updateNXB.jsp");
