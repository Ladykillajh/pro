 ...
 * @author dell
 */
public class UpdateTacGiaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("update", update.selectByMaTacGia(maTacGia));
            if (request.getParameter("update") != null) {
                ...
                response.sendRedirect("tacgiaAdmin");
            }
            RequestDispatcher rd = request.getRequestDispatcher("/update/updateTacGia.jsp");
