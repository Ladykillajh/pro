 ...
 * @author dell
 */
public class UpdateChiTietSachController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("update", update.selectByMaChiTietSach(maChiTietSach));
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/update/updateChiTietSach.jsp");
