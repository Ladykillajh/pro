 ...
 * @author Auriat
 */
public class InsertTheLoaiController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
           ...
           if(request.getParameter("insert")!=null){
              ...
              TheLoai theLoai= new TheLoai(maLoaiSach, tenLoaiSach);
               System.out.println(theLoai);
               update.insert(theLoai);
               response.sendRedirect("theloai");
           }
//           if(request.getParameter("reset")!=null){
//               
//           }
           RequestDispatcher rd = request.getRequestDispatcher("/insert/InsertTheLoai.jsp");
