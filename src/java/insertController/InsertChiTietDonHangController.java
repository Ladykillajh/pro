 ...
 * @author Auriat
 */
public class InsertChiTietDonHangController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int maDonHang = Integer.valueOf(request.getParameter("donHang"));
            ...
            if (request.getParameter("insert") != null) {
                ...
                ChiTietDonHang ctdh = new ChiTietDonHang(maSach, maDonHang, soLuong, donGia);
...
//               
//           }
            RequestDispatcher rd = request.getRequestDispatcher("/insert/InsertChiTietDonHang.jsp");
