<%-- 
    Document   : TheLoai
    Created on : Oct 23, 2019, 11:11:32 AM
    Author     : Auriat
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" style="padding: 10% 10%; padding-bottom: 0%">
            <table class="table">
                <tr>
                    <th><a href="InsertTheLoai.jsp"> <button class="btn btn-primary">Thêm Thể Loại</button></a></th>
                </tr>
            </table>
            <hr>
        ...
        <div class="container-fluid" style="padding: 2% 10%;text-align: center;vertical-align: central;text-justify: auto">
            ...
            <table border="1" cellspacing="10px" class="table">
                ...
                <c:forEach var="tl" items="${TheLoai}">
                    <tr>
                        <td>${tl.maLoaiSach}</td>
                        <td>${tl.tenLoaiSach}</td>

                        <td>
                            <a href="updateTheLoai?maLoaiSach=${tl.maLoaiSach}"><input type="submit" class="btn btn-info" value="Sửa"/></a> 
