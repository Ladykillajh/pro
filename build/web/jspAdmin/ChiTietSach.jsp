<%-- 
    ...
    Created on : Oct 23, 2019, 11:13:56 AM
    Author     : Auriat
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" style="padding: 10% 10%; padding-bottom: 0%">
            <table class="table">
                <tr>
                    <th><a href="InsertChiTietSach.jsp"> <button class="btn btn-primary">Thêm Chi Tiết Sách</button></a></th>
                </tr>
            </table>
            <hr>
        ...
        <div class="container-fluid" style="padding: 2% 10%;text-align: center;vertical-align: central;text-justify: auto">
            ...
            <table border="1" cellspacing="10px" class="table">
                ...
                <c:forEach var="cts" items="${ChiTietSach}">
                    <tr>
                        <td>${cts.maChiTietSach}</td>
                        <td>${cts.maSach}</td>
                        <td>${cts.maNgonNgu}</td>
                        <td>${cts.tongSoTrang}</td>
                        <td>${cts.trongLuong}</td>
                        <td>${cts.kichThuoc}</td>
                        <td>${cts.namXuatBan}</td>

                        <td>
                            <a href="updateChiTietSach?maChiTietSach=${cts.maChiTietSach}"><input type="submit" class="btn btn-info" value="Sửa"/></a> 
