<%-- 
    Document   : InsertChiTietDonHang
    Created on : Oct 23, 2019, 2:35:22 PM
    Author     : Auriat
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container" style="padding: 10% 10%;text-align: center;vertical-align: central;text-justify: auto">
            ...
            <form action="../insertChiTietDonHangController" method="POST">
                <table class="table">
                    <tr>
                        <td>Mã Sách</td>
                    ...
                    <tr>
                        <td>Đơn Hàng</td>
                        <td><input type="text" name="donHang" value=""></td>
                    </tr>
                    <tr>
                        <td>Số Lượng</td>
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <input class="btn btn-primary" type="submit" name="insert" value="Thêm"></input>
                            <button class="btn btn-danger" type="reset" name="reset">Nhập Lại</button>
                        </td>
                    </tr>
                    </table>
            </form>
